# Civil Materials Front-Door Visual Redesign Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rebuild the `showcase-proof` front-door visuals so they feel closer to `nature-skills` while remaining grounded in real civil-materials evidence outputs.
...
**Files:**
- Modify: `skills/civil-materials-figure/tests/test_figure_gallery.py`
- Modify: `plugins/civil-materials-skills/skills/civil-materials-figure/tests/test_figure_gallery.py`
...
**Files:**
- Modify: `skills/civil-materials-figure/scripts/build_showcase_proof_assets.py`
- Modify: `plugins/civil-materials-skills/skills/civil-materials-figure/scripts/build_showcase_proof_assets.py`
...
- Refresh: `skills/civil-materials-figure/assets/showcase-proof/*`
- Refresh: `plugins/civil-materials-skills/skills/civil-materials-figure/assets/showcase-proof/*`
