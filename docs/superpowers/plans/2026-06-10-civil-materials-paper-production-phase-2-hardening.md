# Civil Materials Paper Production Phase 2 Hardening Implementation Plan
...
**Architecture:** Keep `civil-materials-research` as the thin front door and keep shared paper-production contracts under `skills/_shared/paper-production/`. Phase 2 adds three things around the existing slice: route-smoke examples, filled handoff artifacts that can be audited, and release checks that prove those artifacts stay mirrored and coherent. Full end-to-end rehearsal and broader route expansion stay out of this pass.
...
- `skills/civil-materials-research/tests/test_paper_production_route_smoke.py`
  - New smoke-contract test for the WER-EA mini-review route and the orchestrator output shape.
- `skills/civil-materials-research/examples/library/paper-production-mini-review-example.md`
  - New concrete example showing the orchestrator response for a blocked WER-EA mini-review workflow.
- `skills/civil-materials-research/examples/library/library-index.md`
...
- `skills/civil-materials-research/tests/test_paper_production_orchestrator.py`
...
- `plugins/civil-materials-skills/skills/_shared/paper-production/examples/wer-ea-mini-review-weakness-routing.csv`
  - Mirror copy of the filled weakness-routing sample.
- `plugins/civil-materials-skills/skills/_shared/paper-production/examples/wer-ea-mini-review-gate-report.md`
  - Mirror copy of the filled gate report sample.
- `plugins/civil-materials-skills/skills/civil-materials-research/examples/library/paper-production-mini-review-example.md`
  - Mirror copy of the route-smoke example.
- `plugins/civil-materials-skills/skills/civil-materials-research/examples/library/library-index.md`
  - Mirror copy of the updated example index.
- `plugins/civil-materials-skills/skills/civil-materials-research/references/paper-production-orchestrator.md`
...
**Files:**
- Create: `skills/civil-materials-research/tests/test_paper_production_route_smoke.py`
- Create: `skills/civil-materials-research/examples/library/paper-production-mini-review-example.md`
- Modify: `skills/civil-materials-research/examples/library/library-index.md`
...
EXAMPLE = ROOT / "skills" / "civil-materials-research" / "examples" / "library" / "paper-production-mini-review-example.md"
...
Run: `python -m unittest discover -s skills/civil-materials-research/tests -p "test_paper_production_route_smoke.py" -v`
...
## Blocked Gates
- `G2 Source Anchoring` -> next skill `civil-materials-reader` -> expected artifact `reader-package/source_map.json`
...
```bash
git add skills/civil-materials-research/tests/test_paper_production_route_smoke.py skills/civil-materials-research/examples/library/paper-production-mini-review-example.md skills/civil-materials-research/examples/library/library-index.md
...
- Modify: `skills/civil-materials-research/references/paper-production-orchestrator.md`
...
Run: `python -m unittest discover -s skills/civil-materials-research/tests -p "test_paper_production_orchestrator.py" -v`
...
W-G2-001,gate:G2,major,source_anchor_missing,"FTIR and pull-off evidence are unanchored",civil-materials-reader,"Rebuild page/table anchors for mechanism claims",reader-package/source_map.json,open,pending
W-G4-001,gate:G4,major,figure_caption_boundary,"Figure caption still overclaims chemical mechanism",civil-materials-figure,"Rewrite caption boundary and relink source anchors",figure_handoff.csv,fixed,pending
W-G6-001,reviewer:R1,minor,claim_strength,"Reviewer flagged causal wording beyond available evidence",civil-materials-polishing,"Downgrade wording and add reviewer-risk note",claim-strength-audit.md,regression-checked,pass
```
...
|---|---|---|---|---|---|---|---|
| G2 | Source Anchoring | blocked | 18 anchored papers; 12 missing page-level anchors | `source_map.json` updates for 12 papers | W-G2-001 | civil-materials-reader | unsupported mechanism synthesis |
| G4 | Figure And Table Integrity | fail | figure intake exists but caption boundary still overclaims | caption rewrite with source anchors | W-G4-001 | civil-materials-figure | reviewer may reject mechanism figure |
| G6 | Reviewer Simulation | pass | routed reviewer fix rechecked | none | W-G6-001 | civil-materials-polishing | residual wording risk is controlled |
```
...
```bash
git add skills/_shared/paper-production/examples skills/civil-materials-research/references/paper-production-orchestrator.md skills/civil-materials-research/tests/test_paper_production_orchestrator.py
...
- Modify: `skills/civil-materials-research/tests/test_paper_production_orchestrator.py`
...
with tempfile.TemporaryDirectory() as tmp:
    ...
    bad_gate.write_text(
        "| gate_id | gate_name | status | evidence_checked | missing_inputs | routed_weakness_ids | next_skill | reviewer_risk |\n"
        "|---|---|---|---|---|---|---|---|\n"
        "| G2 | Source Anchoring | blocked | anchors missing | source_map.json | W-G2-404 | civil-materials-reader | unsupported claim |\n",
        encoding="utf-8",
    )
...
```bash
git add skills/_shared/paper-production/audit_paper_production.py skills/civil-materials-research/tests/test_paper_production_orchestrator.py
...
- Create: `plugins/civil-materials-skills/skills/_shared/paper-production/examples/wer-ea-mini-review-weakness-routing.csv`
- Create: `plugins/civil-materials-skills/skills/_shared/paper-production/examples/wer-ea-mini-review-gate-report.md`
- Create: `plugins/civil-materials-skills/skills/civil-materials-research/examples/library/paper-production-mini-review-example.md`
- Modify: `plugins/civil-materials-skills/skills/civil-materials-research/examples/library/library-index.md`
- Modify: `plugins/civil-materials-skills/skills/civil-materials-research/references/paper-production-orchestrator.md`
...
```bash
git add scripts/run_release_checks.py plugins/civil-materials-skills/skills/_shared/paper-production/examples plugins/civil-materials-skills/skills/civil-materials-research/examples/library plugins/civil-materials-skills/skills/civil-materials-research/references/paper-production-orchestrator.md
...
Run: `python -m unittest discover -s skills/civil-materials-research/tests -p "test_paper_production*.py" -v`
Expected: PASS
...
Expected: updated `civil-materials-*` skills and `_shared` copied into the installed skills directory
...
```bash
git add skills/civil-materials-research/tests/test_paper_production_route_smoke.py skills/civil-materials-research/examples/library/paper-production-mini-review-example.md skills/civil-materials-research/examples/library/library-index.md skills/civil-materials-research/references/paper-production-orchestrator.md skills/_shared/paper-production/examples skills/_shared/paper-production/audit_paper_production.py skills/civil-materials-research/tests/test_paper_production_orchestrator.py scripts/run_release_checks.py plugins/civil-materials-skills/skills/_shared/paper-production/examples plugins/civil-materials-skills/skills/civil-materials-research/examples/library plugins/civil-materials-skills/skills/civil-materials-research/references/paper-production-orchestrator.md
git commit -m "feat: harden civil materials paper-production proofs"
```
