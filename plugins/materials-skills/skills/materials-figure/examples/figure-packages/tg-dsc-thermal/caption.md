...
Template-only WER-EA figure package: thermal decomposition and heat flow.

## What The Figure Supports

- thermal decomposition and heat flow.

## What The Figure Does Not Prove

- This template does not prove universal thermal behavior for all materials.
