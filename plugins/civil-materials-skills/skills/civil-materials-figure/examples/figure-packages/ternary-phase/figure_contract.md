...
Ternary Phase figures must show three-component composition relationships as material-specific and condition-dependent rather than universal.

## Evidence Chain

| Panel | Evidence source | Source anchor | What it supports | Boundary |
|---|---|---|---|---|
| a | source_data.csv | D001 | phase diagram | template only |
| b | source_data.csv | D002 | composition boundaries | template only |
| c | source_data.csv | D003 | optimal region | template only |
