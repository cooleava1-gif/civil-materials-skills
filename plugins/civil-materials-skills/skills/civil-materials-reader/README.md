...
- PDF or text of a civil-materials paper
...
- Example:
  `skills/civil-materials-reader/examples/waterborne-epoxy-evidence-chain-example.md`
- Sample output tree:
  `outputs/wer-ea-30-reading-sample/`

## Validation

- Contract tests live under `skills/civil-materials-reader/tests/`
