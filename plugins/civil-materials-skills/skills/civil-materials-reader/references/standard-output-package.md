# Civil Materials Reader Standard Output Package
...
| `citation_handoff.csv` | required | Citation matrix handoff rows for `civil-materials-citation`. |
| `figure_handoff.csv` | required | Figure planning handoff rows for `civil-materials-figure`. |
