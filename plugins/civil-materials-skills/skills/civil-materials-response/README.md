...
resubmission note set for a civil-materials manuscript.
...
- Core regression test:
  `skills/civil-materials-response/tests/test_response_examples.py`
- Pressure test:
  `skills/civil-materials-response/tests/pressure-tests/aggressive-reviewer-mechanism-request.md`
- Bundle verification:
