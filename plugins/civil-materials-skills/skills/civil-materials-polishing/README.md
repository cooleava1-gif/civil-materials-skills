...
civil-materials prose. It is where rough English, literal translation, and
...
- Example:
  `skills/civil-materials-polishing/examples/claim-strength-polishing-example.md`
- Related library example:
  `skills/civil-materials-research/examples/library/polishing-claim-strength-example.md`

## Validation

- Core regression test:
  `skills/civil-materials-polishing/tests/test_polishing_references.py`
- Pressure test:
  `skills/civil-materials-polishing/tests/pressure-tests/overclaim-and-literal-translation.md`
- Bundle verification:
