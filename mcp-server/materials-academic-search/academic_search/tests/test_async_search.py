...
class AsyncSearchConcurrencyTest(unittest.TestCase):
    def test_async_search_calls_all_adapters(self):
        """Verify that search_materials_async calls all adapters."""
        ...
        result = asyncio.run(service.search_materials_async({"topic": "asphalt bonding"}))
    ...
    def test_async_search_handles_adapter_failure(self):
        ...
        result = asyncio.run(service.search_materials_async({"topic": "test"}))
