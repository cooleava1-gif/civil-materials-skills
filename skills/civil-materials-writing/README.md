...
- Example:
  `skills/civil-materials-writing/examples/review-outline-example.md`
- Additional example:
  `skills/civil-materials-writing/examples/waterborne-epoxy-abstract-example.md`

## Validation

- Core regression test:
  `skills/civil-materials-writing/tests/test_writing_skill.py`
- Pressure test:
  `skills/civil-materials-writing/tests/pressure-tests/missing-data-writing.md`
- Bundle verification:
