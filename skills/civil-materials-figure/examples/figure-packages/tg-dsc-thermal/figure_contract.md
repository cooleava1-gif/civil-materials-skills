...
TG-DSC Thermal figures must show thermal decomposition and heat flow as material-specific and condition-dependent rather than universal.

## Evidence Chain

| Panel | Evidence source | Source anchor | What it supports | Boundary |
|---|---|---|---|---|
| a | source_data.csv | D001 | TGA curve | template only |
| b | source_data.csv | D002 | DTG curve | template only |
| c | source_data.csv | D003 | DSC curve | template only |
