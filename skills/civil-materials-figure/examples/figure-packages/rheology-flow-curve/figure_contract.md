...
Rheology Flow Curve figures must show viscosity versus shear rate behavior as material-specific and condition-dependent rather than universal.

## Evidence Chain

| Panel | Evidence source | Source anchor | What it supports | Boundary |
|---|---|---|---|---|
| a | source_data.csv | D001 | flow curve | template only |
| b | source_data.csv | D002 | viscosity profile | template only |
| c | source_data.csv | D003 | shear thinning behavior | template only |
