...
Creep-Recovery figures must show viscoelastic recovery behavior as material-specific and condition-dependent rather than universal.

## Evidence Chain

| Panel | Evidence source | Source anchor | What it supports | Boundary |
|---|---|---|---|---|
| a | source_data.csv | D001 | creep compliance | template only |
| b | source_data.csv | D002 | recovery ratio | template only |
| c | source_data.csv | D003 | permanent deformation | template only |
