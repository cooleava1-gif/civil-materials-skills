...
Use this atlas when choosing a production figure family before coding. Each chart type links a materials claim to a safe code pattern and a visual reference.
...
| box/violin plot | Replicate-rich performance datasets | Raw points plus distribution shape | (generate with `scripts/materials_plot_svg.py`) | Using distribution plots for n < 5 |
...
- `assets/rich-gallery/generated/` — 10 general materials figures (SVG)
