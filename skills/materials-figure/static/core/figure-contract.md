...
A publication-quality materials figure is a visual argument, not an isolated pretty plot. Every figure starts from a claim, an evidence chain, a backend decision, and a reviewer-risk check before code or aesthetics.
