...
Module: materials-research paper-production orchestrator
...
- `G2 Source Anchoring` -> next skill `materials-reader` -> expected
  artifact `reader-package/source_map.json`
- `G3 Mechanism Boundary` -> next skill `materials-reader` ->
