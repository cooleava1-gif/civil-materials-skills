...
Route research workflows across the civil-materials skill bundle. This is the day-to-day entry point for most multi-skill tasks.
...
- Recommend `civil-materials-citation` first when literature gaps exist.
